...
router.post('/professors/students/setScore' , csrfProtection, function(req, res){
   ...
   if(req.session.profile){
         ...
         var content = {student_id:req.body.student_id,tname:req.body.tname, research_title:req.body.research_title, first_second: req.body.first_second, semester: req.body.year, new_score:req.body.new_score, new_comment: req.body.comment};
