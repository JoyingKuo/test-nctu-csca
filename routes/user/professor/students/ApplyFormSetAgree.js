...
router.post('/professors/students/ApplyFormSetAgree', csrfProtection, function(req, res){
	...
	//console.log(req_member);
			...
			{
				var req_member = { student_id : req.body.student[i].student_id,tname : req.body.tname, research_title :  req.body.research_title, first_second:req.body.first_second, semester: req.body.year};
			//	console.log(req_member);
			...
			var formInfo = {research_title :  req.body.research_title, tname : req.body.tname, first_second:req.body.first_second, agree :req.body.agree, semester:req.body.year};
