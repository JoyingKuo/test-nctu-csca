...
router.get('/students/graduate/reorder', StudentId, StudentProfile, queryFree, queryGeneral, queryPass, queryChange, queryCourse, queryNow, queryRule, processOther, processCS, processFinal, currentOther, currentCS,  processReorder, function(req, res){
	console.log(res.locals.lanes);
