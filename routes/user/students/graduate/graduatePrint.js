...
router.get('/students/graduate/print', StudentId, StudentProfile, queryFree, queryGeneral, queryPass, queryCourse, queryNow, queryRule, processOther, processCS, processFinal, processPrint, currentOther, currentCS, function(req, res){
