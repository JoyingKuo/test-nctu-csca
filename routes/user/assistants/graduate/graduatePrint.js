...
router.get('/assistants/graduate/print', StudentId, StudentProfile, queryFree, queryGeneral, queryPass, queryCourse, queryRule, processOther, processCS, processFinal, processPrint, function(req, res){
